...
# Training dataloader.
class ucf_train(Dataset):

    def __init__(self, args, shuffle = True, data_percentage=1.0, split=1):
        self.args = args
        if split == 1:
            self.all_paths = open('dataset/VAR/ucf101/trainlist01.txt',
                                  'r').read().splitlines()
        else:
            print(f'Invalid split input: {split}')

        if args.task == 'har':
            self.classes = json.load(open('dataset/VAR/ucf101/action_classes.json'))['classes']
        elif args.task == 'pri':
            self.classes = pickle.load(open('dataset/VAR/ucf101/ucf101_privacy_attribute_label.pickle', 'rb'))
    ...
    def process_data(self, idx):
        if self.args.hide:
            if self.args.cov_ran:
                ...
                cover = Image.open('dataset/COCO/000000002006.jpg') #1
                # cover = Image.open('dataset/COCO/1/00070.jpg') #2
                # cover = Image.open('dataset/COCO/3/00000.jpg') #3
                # cover = Image.open('dataset/COCO/4/00000.jpg') #4
                # cover = Image.open('dataset/COCO/5/00065.jpg') #5
                # cover = Image.open('dataset/COCO/6/00040.jpg') #6
                # cover = Image.open('dataset/COCO/7/00000.jpg') #7
                # cover = Image.open('dataset/COCO/8/00000.jpg') #8
                # cover = Image.open('dataset/COCO/9/00000.jpg') #9
                # cover = Image.open('dataset/COCO/10/00000.jpg') #10
        ...
        vid_path = 'dataset/VAR/ucf101' + '/ucf101/' + \
...
class ucf_val(Dataset):
    ...
    def __init__(self, args, shuffle = True, data_percentage=1.0, mode=0, skip=1, \
        ...
        if split == 1:
            self.all_paths = open('dataset/VAR/ucf101/testlist01.txt',
                                  'r').read().splitlines()
        else:
            print(f'Invalid split input: {split}')
    ...
    def process_data(self, idx):
        if self.args.hide:
            ...
            # cover = Image.open(cover_dir).convert('RGB')
            cover = Image.open('dataset/COCO/000000002006.jpg') #1
            # cover = Image.open('dataset/COCO/1/00000.jpg') #1
            # cover = Image.open('dataset/COCO/1/00070.jpg') #2
            # cover = Image.open('dataset/COCO/3/00000.jpg') #3
            # cover = Image.open('dataset/COCO/4/00000.jpg') #4
            # cover = Image.open('dataset/COCO/5/00065.jpg') #5
